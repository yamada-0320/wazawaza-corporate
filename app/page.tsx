      ...
      <main className="home">
            ...
            <div className="mvLogoArea">
              ...
              <div className="logoRight">
                <svg
                  ...
                  style={{ enableBackground: "new 0 0 365.1 142" }}
                  xmlSpace="preserve"
                >
                  <style type="text/css">
                    {`.st0{fill:none;stroke:#FFFFFF;stroke-width:35;stroke-miterlimit:10;}`}
        ...
        <section className="scProduct">
          ...
          <div className="productSider">
            {/* ※ microCMS 連携設定後にここに動的データを流し込みます */}
            <p className="empty_list">事例読み込み準備中...</p>
          </div>
